...
namespace Antpoll.Domain.Core.Interfaces.Infrastructure.DataBase
{
    /// <summary>
        ...
        where TEntity : class, new()
    {
        ...
        /// <returns></returns>
        IEnumerable<TEntity> GetPagedElements<TS>(int pageIndex, int pageCount, Expression<Func<TEntity, TS>> orderByExpression, bool ascending);
